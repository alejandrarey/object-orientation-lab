...
favoriteThings.book = 'Harry Potter Series'
...
console.log(`Dad drives a ${make} ${model} from ${year} in ${color}`)
//////////////////////////// PROBLEM 7 ////////////////////////////
...
class Cat {
  ...
  const dixie = new Cat('Dixie', 6, 'ivory')

console.log(dixie.color)
...
const oculusReparo = new Wizard('Harry', 12, 'Oculus Reparo')

console.log(oculusReparo.name)
oculusReparo.castSpell()
